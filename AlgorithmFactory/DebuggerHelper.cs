...
while not sys.gettrace():
    time.sleep(0.25)");
                        ...
                        case DebuggingMethod.DebugPy:
                            Log.Trace("DebuggerHelper.Initialize(): waiting for debugpy debugger to attach at localhost:5678...");
                            PythonEngine.RunSimpleString("import debugpy; debugpy.listen(5678); debugpy.wait_for_client()");
                            break;

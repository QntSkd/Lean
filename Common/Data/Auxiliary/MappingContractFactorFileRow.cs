...
{
    /// <summary>
    /// Collection of factors for continuous contracts and their back months contracts for a specific mapping mode
    /// <see cref="FactorFileRow.DataMappingMode"/> and date
    /// </summary>
